# factory method é um padrão para criação que permite definir uma interface para 
# criar objetos, mas deixa as subclasses decidirem quais objetos criar. O 
# Factory metho permite adiar a instanciação para as subclasses, garantindo o
